...
-- luacov.config
	...
	luarocks_noprint= function(cmd, env_variables) return execute_output(lua .. " -e\"require('luacov.runner')('" .. testing_paths.testing_dir
	...
	test_environment.testing_paths = testing_paths
	test_environment.md5sums = md5sums
	test_environment.testing_env_variables = testing_env_variables
	test_environment.luarocks = luarocks
	test_environment.luarocks_noprint = luarocks_noprint
